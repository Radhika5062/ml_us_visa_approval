...
class DataValidationConfig:
    ...
    drift_report_file_path:str = os.path.join(data_validation_dir_name, 
...
class ModelEvaluationConfig:
    changed_threshold_score:float = MODEL_EVALUATION_CHANGED_TRHESHOLD_SCORE
